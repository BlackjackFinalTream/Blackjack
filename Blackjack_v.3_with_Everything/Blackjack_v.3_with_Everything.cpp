	...
	do {
		...
		do
		{
			...
			case 3: {
				...
				cout << "\n" << player1 << " has " << player1total << " and bet $" << player1bamount << endl;
				cout << "\n" << player2 << " has " << player2total << " and bet $" << player2bamount << endl;
				cout << "\n" << player3 << " has " << player3total << " and bet $" << player3bamount << endl;
				if (player1total > 21) {
					playeramount1 -= player1bamount;
					cout << player1 << " lose $" << player1bamount << " and now has $" << playeramount1 << endl;
				}
				...
				{
					if ((player3total < player2total || player3total > 21) || (player3total < player1total || player3total > 21)) {
						playeramount3 += player3bamount;
						cout << player3 << " won $" << player3bamount << " and now has $" << playeramount3 << endl;
					}
					else
					{
						if ((player1total <= 21 && player3total > player2total) || (player2total <= 21 && player3total > player2total))
						{
							playeramount3 -= player3bamount;
			...
			cin >> anstwo;
			if ((anstwo == 'n' || anstwo == 'N') || playeramount1 == 0) {
				break;
			}
		} while (true);
		if ((anstwo == 'n' || anstwo == 'N') || playeramount1 == 0) {
...
void hitplayer2() {
	while (player2total <= 21) {
		...
		if (choice == 'H' || choice == 'h') {
			...
			card_choose();
			player2total = playertotal;
			cout << player3 << " Total: " << player2total << endl;
		}
		else {
			cout << "You choose to stay." << endl;
			break;
